...
**"What I Do makes me Wiser."** — 오늘 입력한 행동(What I Do)이 모여, 내일의 나를 더 현명하게(Wiser) 만듭니다.

Work · Life · Money 세 기둥으로 목표를 정리하고, 달성 여부와 진척을 한눈에 보는 라이프 플래너. 사용자는 **와이저(Wiser)**라고 부릅니다.
